...
const demoUsers: Record<UserRole, User> = {
  ...
  doctor: {
    ...
    email: 'priya.sharma@royalpharmacy.com',
    phone: '9876543211',
    role: 'doctor',
  },
  clinic_staff: {
    id: 'cs1',
    name: 'Anitha R',
    email: 'anitha@royalpharmacy.com',
    phone: '9876543212',
    role: 'clinic_staff',
  },
  pharmacy_staff: {
    id: 'ps1',
    name: 'Suresh M',
    email: 'suresh@royalpharmacy.com',
    phone: '9876543213',
    role: 'pharmacy_staff',
  },
  lab_staff: {
    id: 'ls1',
    name: 'Kavitha S',
    email: 'kavitha@royalpharmacy.com',
    phone: '9876543214',
    role: 'lab_staff',
  },
  physiotherapist: {
  ...
  nurse: {
    id: 'n1',
    name: 'Lakshmi V',
    email: 'lakshmi@royalpharmacy.com',
    phone: '9876543216',
    role: 'nurse',
  },
  admin: {
